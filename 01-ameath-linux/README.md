...
<p align="center">
  Ameath 桌面宠物的非官方 Linux 移植版，收录于 <a href="https://github.com/HedgehogBeta/Bue_Toolbox">Bue_Toolbox</a>。
</p>
...
```bash
git clone https://github.com/HedgehogBeta/Bue_Toolbox.git
cd Bue_Toolbox/01-ameath-linux
./run.sh
```
...
打包脚本会生成 Python wheel、源码包、便携版压缩包、Debian 包和 `SHA256SUMS`。GitHub Actions 会在推送 `ameath-linux-v*` 标签时重建并发布同样的产物。
